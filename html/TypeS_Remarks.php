<?php
    ...
    if(isset($_POST['insert']))
    {
        ...
        $query = "INSERT INTO `remarks`(`remarks_type`, `remarks_desc`) VALUES ('$type','$details')";
    ...
    if (isset($_POST['edit'])) {
        ...
        $updatequery = "UPDATE remarks SET remarks_type = '$rType', remarks_desc = '$rDesc' WHERE remarks_id = $rid";
    ...
    if (isset($_POST['deactivate'])) 
    {
        ...
        if ($_POST['stat'] == 'Active') {
            $updatequery = "UPDATE remarks SET remarks_stat = 'Inactive' WHERE remarks_id = $id";
        } else {
            $updatequery = "UPDATE remarks SET remarks_stat = 'Active' WHERE remarks_id = $id";
        }
        	...
        	<div class="row">
                <div class="col-md-12">
                    <ul class="breadcrumbs-alt">
                        ...
                        <li>
                            <a class="current" href="#"> Remarks</a>
                        </li>
                    </ul>
                </div>
            </div>
