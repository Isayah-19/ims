...
<head>
    ...
    <title>DeKUT-IMS-Files and Documents</title>
...
if (mysqli_connect_errno())
{
  ...
  $sql= "SELECT upload_file_id,upload_filename, upload_category, upload_date, upload_filepath from upload WHERE upload_filetype = 'Records'";
...
if (mysqli_connect_errno())
{
  ...
  $sql= "SELECT upload_file_id,upload_filename, upload_category, upload_date, upload_filepath from upload WHERE upload_filetype = 'Printables'";
                        ...
                        <div class="col-md-4 form-group">
                            *Category
                            <select name="UPLOAD_CATEGORY" type="text" class="form-control" required>
                                <?php
                                    $query = "SELECT upload_file_category FROM upload_category WHERE upload_category_stat = 'Active'";
