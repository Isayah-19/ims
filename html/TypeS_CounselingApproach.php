<?php
    ...
    if(isset($_POST['insert']))
    {
        ...
        $query = "INSERT INTO `couns_approach`(`couns_appr`, `approach_desc`) VALUES ('$name','$desc')";
    ...
    if (isset($_POST['edit'])) 
    {
        ...
        $updatequery = "UPDATE couns_approach SET couns_appr = '$nature', approach_desc = '$desc' WHERE appr_id = $id";
    ...
    if (isset($_POST['deactivate'])) 
    {
        ...
        //if ($_POST['stat'] == 'Active') {
           // $updatequery = "UPDATE couns_approach SET Couns_APPROACH_STAT = 'Inactive' WHERE appr_id = $id";
        //} else {
          //  $updatequery = "UPDATE couns_approach SET Couns_APPROACH_STAT = 'Active' WHERE appr_id = $id";
        //}
...
<head>
    ...
    <title>DeKUT_IMS-Counseling Approach</title>
                    ...
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT * FROM `couns_approach`";
                                $records = mysqli_query($db,$sql);

                                while ($approach = mysqli_fetch_assoc($records)) 
                                {
                                    $Id = $approach['appr_id'];
                                    $Capproach = $approach['couns_appr'];
                                    $apDesc = $approach['approach_desc'];
