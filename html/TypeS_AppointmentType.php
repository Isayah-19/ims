<?php
    ...
    if(isset($_POST['insert']))
    {
        ...
        $query = "INSERT INTO `couns_appointmentype`(`appmntype`) VALUES ('$type')";
    ...
    if (isset($_POST['deactivate'])) 
    {
        ...
        if ($_POST['stat'] == 'Active') {
            $updatequery = "UPDATE couns_appointmentype SET appmnstat = 'Inactive' WHERE appmnid = $id";
        } else {
            $updatequery = "UPDATE couns_appointmentype SET appmnstat = 'Active' WHERE appmnid = $id";
        }
    ...
    if (isset($_POST['edit'])) {
        ...
        $id = $_POST['apId'];
        $type = $_POST['apType'];
        $updatequery = "UPDATE couns_appointmentype SET appmntype = '$type' WHERE appmnid = $id";
        mysqli_query($db,$updatequery);
    }
?>
...
<head>
    ...
    <title>DeKUT_IMS-Appointment Type</title>
                    ...
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody id="appmnt">
                            <?php
                                ...
                                $sql = "SELECT * FROM `couns_appointmentype`";
                                $records = mysqli_query($db,$sql);

                                while ($appmnt = mysqli_fetch_assoc($records)) 
                                {
                                    $apId = $appmnt['appmnid'];
                                    $apType = $appmnt['appmntype'];
                                    $status = $appmnt['appmnstat']; 
                            ?>
