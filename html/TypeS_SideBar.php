    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li class="sub-menu">
                    <a <?php if($currentPage=='DeKUT_IMS-UserManagement') { echo 'class="active"';} ?> href="TypeS_UserManagement.php">
                        <i class="fa fa-users"></i>
                        <span>User Management</span>
                    </a>
                </li>
                <li class="sub-menu">
                    <a <?php if($currentPage=='DeKUT_IMS-System Configurations') { echo 'class="active"';} ?> >
                   ...
                   <ul class="sub">
                    ...
                    <li><a href="TypeS_CivilStatus.php">Marital Status</a></li>
