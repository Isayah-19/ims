...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $db->prepare("INSERT INTO `appointments`(`stud_id`, `email`, `date_sched`, `couns_issue`, `status`, `date_created`) VALUES (?, ?, ?, ?, ?, current_timestamp())");
    $stmt->bind_param( $stud_id, $email, $schedule, $couns_issue, $status);
