<?php
    ...
    if(isset($_POST['insert']))
    {
        ...
        $query = "INSERT INTO `useroles`(`userole`) VALUES ('$roles')";
    ...
    if (isset($_POST['edit'])) 
    {
        ...
        $updatequery = "UPDATE useroles SET userole = '$usRole' WHERE userole_id = $id";
    ...
    if (isset($_POST['deactivate'])) 
    {
        ...
        if ($_POST['stat'] == 'Active') {
            $updatequery = "UPDATE useroles SET userole_stat = 'Inactive' WHERE userole_id = $id";
        } else {
            $updatequery = "UPDATE useroles SET userole_stat = 'Active' WHERE userole_id = $id";
        }
...
<head>
    ...
    <title>DeKUT_IMS-User Roles</title>
                    ...
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT * FROM `useroles`";
                                $records = mysqli_query($db,$sql);

                                while ($uRoles = mysqli_fetch_assoc($records)) 
                                {
                                    $Id = $uRoles['userole_id'];
                                    $role = $uRoles['userole'];
                                    $urStat = $uRoles['userole_stat'];
                            ?>
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="role" value="<?php echo $role ?>">
                                                </div>
                                                <br><br>
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="POST">
                                                <div class="hidden">
                                                    ...
                                                    <input name="stat" value="<?php echo $urStat ?>">
                                                </div>
                                                <br>  
