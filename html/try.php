...
<?php 
$currentPage ='DeKUT-IMS-Profiling';
include('header.php');
...
include('config.php');
  ...
  $sql= "SELECT `stud_Id` as ID, `stud_regNo`, `stud_fullname` AS FULLNAME,
        CONCAT(`stud_course`,' ',`stud_yrlevel`) AS COURSE,`stud_status`FROM `stud_profile`WHERE stud_status='Active'";
                                    ...
                                    <p>Input student's number and student's name before proceeding</p><br/>
                                        <form role="form" action="">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="student_no" placeholder="C027-01-000-20XX">
                                            </div>
                                            <div class="form-group">
