    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a class="active" href="counseling.php">
                    ...
                    <div class="panel-body">
                        <div class="position-center ">
                            <div class="text-center">
                                <a href="#myModal" data-toggle="modal" class="btn btn-success"> Start Counseling Service </a>
                            </div>
        <!--MODALSSSS-->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" >
                                    ...
                                    <p>Input student's number or student's name before proceeding</p>
                                        <form role="form" action="counselingservices.php">
                                            <div class="form-group">
                                                <label for="studentnumber">Student Number</label>
                                                <input type="text" class="form-control" id="studentnumber" placeholder="20XX-XXXXX-CM-0">
                                            </div>
                                            <div class="form-group">
                                                <label for="studentname">Name</label>
                                                <input type="text" class="form-control" id="studentname" placeholder="Fullname">
                                            </div>
