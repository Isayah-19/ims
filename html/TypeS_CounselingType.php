<?php
    ...
    if(isset($_POST['insert']))
    {
        ...
        $query = "INSERT INTO `couns_type`(`couns_type`) VALUES ('$type')";
    ...
    if (isset($_POST['edit'])) 
    {
        ...
        $updatequery = "UPDATE couns_type SET couns_type = '$type' WHERE couns_type_id = $id";
    ...
    if (isset($_POST['deactivate'])) 
    {
        ...
        if ($_POST['stat'] == 'Active') {
            $updatequery = "UPDATE couns_type SET couns_type_stat = 'Inactive' WHERE couns_type_id = $id";
        } else 
        {
            $updatequery = "UPDATE couns_type SET couns_type_stat = 'Active' WHERE couns_type_id = $id";
        }
...
<head>
    ...
    <title>DeKUT_IMS-Counseling Type</title>
