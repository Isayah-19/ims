                    ...
                    <div class="adv-table">
                        ...
                        <tbody>
                            <?php
                                ...
                                /* $sql= "  SELECT `stud_regNo`, `stud_fullname`, `stud_course`, 
                                `stud_display_status` FROM `stud_profile` WHERE 'stud_display_status' != 'Inactive'";*/
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 modal-con">
                                                        ...
                                                        <form class="form-inline" method="POST" action="update_status.php">
                                                            ...
                                                            <input type="text" id="stud_display_status" name="stud_display_status" 
                                                    ...
                                                    <!--LAMAN  NG EDUCATIONAL BACKGROUND START-->
                                                            <div class="panel-body">
                                                                ...
                                                                <!--START PART 2-->
                                                                    ...
                                                                    <?php
                                                                        $sql_educ_id = "SELECT * FROM stud_educ_background WHERE studNo_reference ='$NO'";
...
<script>
    function EditStatus(){
        document.getElementById("stud_display_status").removeAttribute("disabled");
