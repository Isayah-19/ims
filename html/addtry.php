                                        ...
                                        <form action="addtrytry.php" method="POST">
                                            ...
                                            <div class="form-content">
                                                ...
                                                <?php  
                                                    ...
                                                    $result = mysqli_query($db, "SELECT MAX(Batch_ID) FROM t_group_batch");
                                                ...
                                                ?>
                                                 ...
                                                 <div class="form-group">
                                                    <input type="text" name="r_batch" value="<?php echo $finalid; ?>">
                                                </div> <?php } ?>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="app_type" value="Behavior Therapy">
                                                </div>
                                                ...
                                                <div class="row group">                                                        
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input maxlength="150" type="text" name="student_name[]" class="form-control" required="" style="color: black;"  />
                                                        </div>
                                                    </div>
                                                   ...
                                                   <div id="studnt_no_list"></div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Unit</label>
                                                            <input maxlength="150" type="text" name="r_unit[]" class="form-control" required="" style="color: black;"  />
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input style="color: black; padding-right: 2px;" type="text" name="r_quantity[]" class="form-control" required="" minlength="3" min="1" max="100" />
                                                        </div>
                                                    </div>
