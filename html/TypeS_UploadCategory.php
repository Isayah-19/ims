<?php
    ...
    if(isset($_POST['insert']))
    {
        ...
        $cat = $_POST['uploadCat'];
        $query = "INSERT INTO `upload_category`(`upload_file_category`) VALUES ('$cat')";
    ...
    if (isset($_POST['deactivate'])) 
    {
        ...
        if ($_POST['status'] == 'Active') {
            $updatequery = "UPDATE upload_category SET upload_category_stat = 'Inactive' WHERE upload_category_id = $id";
        } else {
            $updatequery = "UPDATE upload_category SET upload_category_stat = 'Active' WHERE upload_category_id = $id";
        }
    ...
    if (isset($_POST['edit'])) {
        $id = $_POST['upId'];
        $cat = $_POST['upCat'];
        $updatequery = "UPDATE upload_category SET upload_file_category = '$cat' WHERE upload_category_id = $id";
        mysqli_query($db,$updatequery);
    }
?>
...
<head>
    ...
    <title>DeKUT_IMS-Upload Category</title>
                ...
                <section class="panel">
                    ...
                    <table  class="display table table-bordered table-striped" id="dynamic-table">
                        ...
                        <tbody>
                             <?php
                                // include ('config.php');
                                $sql = "SELECT * FROM `upload_category`";
