...
<head>
    ...
    <title>DeKUT-CIMS-Visit Logs</title>
...
if(isset($_POST['search']) && $_POST['filter'] != 'All')
{
    ...
    $query = "SELECT * FROM visitrecord WHERE visit_purpose ='$valueToSearch' ORDER BY visitdate DESC";
    $search_result = mysqli_query($db,$query);
    
} else {
    $query = "SELECT * FROM visitrecord ORDER BY visitdate DESC";
    $search_result = mysqli_query($db,$query);
}
?>
<!--sidebar end-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <select name="filter" class="form-control input-sm m-bot4">
                                        ...
                                        <?php
                                            $query = "SELECT visit_type FROM visit WHERE visitype_stat = 'Active'";
