...
<head>
    ...
    <title>DeKUT-IMS-Profiling</title>
...
<!--sidebar end-->
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="row">
				<div class="col-md-12">
					<button href="" class="btn btn-primary" ng-click="showAdd()" data-toggle="modal"><i class="fa fa-plus"></i> New Student</button>
                    <button href="#ImportModal" data-toggle="modal" class="btn btn-warning"><i class="fa fa-plus"></i> Import</button>
			...
			<table class="table table-bordered table-striped" style="margin-top:10px;">
				...
				<tbody>
					<tr dir-paginate="member in members|orderBy:sortKey:reverse|filter:search|itemsPerPage:5">
						...
						<td>
							<button type="button" class="btn btn-success" ng-click="showEdit(); selectMember(member);"><i class="fa fa-eye"></i> View</button> 
